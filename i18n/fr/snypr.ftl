...
error-unsupported-compositor = aucune IPC de gestionnaire de fenêtres prise en charge n'a été détectée (ni Hyprland ni Sway) ; cette fonctionnalité n'est pas disponible sur ce compositeur
